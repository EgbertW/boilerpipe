...
import nl.pointpro.boilerpipeng.BoilerpipeDocumentSource;
 ...
 */
public class JavaBoilerpipeHTMLParser extends AbstractSAXParser implements BoilerpipeDocumentSource, BoilerpipeHTMLParser {

  private BoilerpipeHTMLContentHandler contentHandler;

  /**
   * Constructs a {@link JavaBoilerpipeHTMLParser} using a default HTML content handler.
   */
  public JavaBoilerpipeHTMLParser() {
    this(new BoilerpipeHTMLContentHandler());
  }

  /**
   * Constructs a {@link JavaBoilerpipeHTMLParser} using the given {@link BoilerpipeHTMLContentHandler}.
   * 
   * @param contentHandler
   */
  public JavaBoilerpipeHTMLParser(BoilerpipeHTMLContentHandler contentHandler) {
    super(new HTMLConfiguration());
    setContentHandler(contentHandler);
  }

  protected JavaBoilerpipeHTMLParser(boolean ignore) {
    super(new HTMLConfiguration());
  }
