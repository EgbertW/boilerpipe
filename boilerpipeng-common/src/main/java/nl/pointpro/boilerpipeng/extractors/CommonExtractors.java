...
public final class CommonExtractors {
   ...
   *
   * @return The ArticleExtractor instance
   */
   ...
   *
   * @return The DefaultExtractor instance
   */
   ...
   *
   * @return The largest text block extractor instance
   */
   ...
   *
   * @return The canola extractor instance
   */
   ...
   *
   * @return The keep everything extractor instance
   */
