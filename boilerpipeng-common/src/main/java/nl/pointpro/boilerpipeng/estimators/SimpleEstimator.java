 ...
 */
package nl.pointpro.boilerpipeng.estimators;

import nl.pointpro.boilerpipeng.BoilerpipeExtractor;
import nl.pointpro.boilerpipeng.document.TextDocumentStatistics;
import nl.pointpro.boilerpipeng.extractors.ArticleExtractor;
import nl.pointpro.boilerpipeng.extractors.DefaultExtractor;
...
public final class SimpleEstimator {
   ...
   * 
   * @param dsBefore Statistics before
   * @param dsAfter Statistics after
